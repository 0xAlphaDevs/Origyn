...
export function EarningChart({ productEarnings }: any) {
  const totalEarnings = productEarnings.reduce(
  ...
  // if (productEarnings.length > 4) {
  //   const otherEarnings = productEarnings
  //     .slice(4, productEarnings.length)
  //     .reduce(
  //       (acc: number, { earnings }: { earnings: number }) => acc + earnings,
  //       0
  //     );
